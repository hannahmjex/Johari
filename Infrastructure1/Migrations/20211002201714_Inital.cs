    ...
    public partial class Inital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Adjectives", x => x.AdjectiveID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendResponses", x => x.ResponseID);
                    table.ForeignKey(
                        name: "FK_FriendResponses_Adjectives_AdjectiveID",
                        column: x => x.AdjectiveID,
                        principalTable: "Adjectives",
                        principalColumn: "AdjectiveID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FriendResponses_Client_ClientID",
                        column: x => x.ClientID,
                        principalTable: "Client",
                        principalColumn: "ClientID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FriendResponses_Friend_FriendID",
                        column: x => x.FriendID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientResponses_ClientID",
                table: "ClientResponses",
                column: "ClientID");

            migrationBuilder.CreateIndex(
                name: "IX_FriendResponses_AdjectiveID",
                table: "FriendResponses",
                column: "AdjectiveID");

            migrationBuilder.CreateIndex(
                name: "IX_FriendResponses_ClientID",
                table: "FriendResponses",
                column: "ClientID");

            migrationBuilder.CreateIndex(
                name: "IX_FriendResponses_FriendID",
                table: "FriendResponses",
                column: "FriendID");
        }
